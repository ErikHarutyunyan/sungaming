...
function PrevArrow(props) {
  const {onClick} = props;
  return (
    <button onClick={onClick} style={{'--x': "0px", '--y': "0px"}} type="button" aria-label="Slide Prev"
...
function NextArrow(props) {
  const {onClick} = props;
  return (
    <button onClick={onClick} style={{'--x': "44px", '--y': "44px"}} type="button" aria-label="Slide Next"
...
function BlogPrevArrow(props) {
  const {onClick} = props;
  return (
    <button onClick={onClick} style={{'--x': "44px", '--y': "44px"}} type="button"
    ...
    <>
        ...
        <div className="container overflow-hidden">
          <div className="row align-items-center section-text">
            ...
            <div className="col-lg-6">
              <p>Gamestorm Studios provides end-to-end services for clients wishing to employ game development
                businesses skilled in Unity3D, Unreal, PlayCanvas, blockchain, game design, VR, NFT, metaverse, and
                more.</p>
            </div>
          </div>
          <Slider  {...settingsServices} className="services-carousel">
            <div className="slide-area" style="width:100%;display:inline-block">
              <div className="single-slider box-style box-first p-5 px-xl-9 py-xl-10">
                <div className="icon-box d-center">
                  <svg viewBox="0 0 90.32267761230469 100" version="1.1" xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="title-area">
                  ...
                  <p>Integrate our REST API to guarantee high player engagement and provide in-game bonuses for existing
                    and new players. </p>
                  <div className="link-area mt-8"><a className="d-flex align-items-center" href="our-services-details">Learn
                    More<MdOutlineArrowForward/></a></div>
                </div>
              </div>
            </div>
            <div className="slide-area" style="width:100%;display:inline-block">
              <div className="single-slider box-style box-first p-5 px-xl-9 py-xl-10">
                <div className="icon-box d-center">
                  <svg viewBox="0 0 92.85713958740234 100" version="1.1" xmlns="http://www.w3.org/2000/svg"
                       xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g transform="scale(3.5714285714285716)"><title>Icons / create-new-version-icon</title>
                      <desc>Created with Sketch.</desc>
                      <g transform="translate(-350.000000, -289.000000)" fill="#000000">
                ...
                <div className="title-area">
                  ...
                  <p>Get your source account updated in real time, reduce the time and costs of software development
                    service and increase reliability to fit regulated market requirements.</p>
                  <div className="link-area mt-8"><a className="d-flex align-items-center" href="our-services-details">Learn
                    More<MdOutlineArrowForward/></a></div>
                </div>
              </div>
            ...
            <div className="slide-area" style="width:100%;display:inline-block">
              <div className="single-slider box-style box-first p-5 px-xl-9 py-xl-10">
                <div className="icon-box d-center">
                  <svg viewBox="0 0 99.87355041503906 100" version="1.1" xmlns="http://www.w3.org/2000/svg"
                       xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <div className="title-area">
                  ...
                  <p>Get complete consultation, receive technical support and account management on a 24/7 basis.</p>
                  <div className="link-area mt-8"><a className="d-flex align-items-center" href="our-services-details">Learn
                    More<MdOutlineArrowForward/></a></div>
                </div>
              </div>
            ...
            <div className="slide-area" style="width:100%;display:inline-block">
              <div className="single-slider box-style box-first p-5 px-xl-9 py-xl-10">
                <div className="icon-box d-center">
                  <svg viewBox="0 0 78.56375885009766 100" version="1.1" xmlns="http://www.w3.org/2000/svg"
                       xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <div className="title-area">
                  ...
                  <p>Sun Gaming platform integration also introduces the “provable fairness” feature to verify fair play
                    ensuring the game outcomes are determined 5 rounds in advance and players receive it in the coded
                    form. </p>
                  <div className="link-area mt-8"><a className="d-flex align-items-center" href="our-services-details">Learn
                    More<MdOutlineArrowForward/></a></div>
                </div>
            ...
            <div className="slide-area" style="width:100%;display:inline-block">
              <div className="single-slider box-style box-first p-5 px-xl-9 py-xl-10">
                <div className="icon-box d-center">
                  <svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g transform="scale(6.25)">
                      <path d="M8 0c-4.4 0-8 3.6-8 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8zm-3 4l8 4-8 4v-8z"
                            transform="translate(0,0)"></path>
                    </g>
                  </svg>
                </div>
                <div className="title-area">
                  ...
                  <p>Our Jackpot engine is a perfect solution for all our partners that want to boost the loyalty level
                    of their
                    players and maximise their attraction to our games. </p>
                  <div className="link-area mt-8"><a className="d-flex align-items-center" href="our-services-details">Learn
                    More<MdOutlineArrowForward/></a></div>
                </div>
              </div>
            ...
            <div className="slide-area" style="width:100%;display:inline-block">
              <div className="single-slider box-style box-first p-5 px-xl-9 py-xl-10">
                <div className="icon-box d-center">
                  <svg viewBox="0 0 99.99996185302734 100" version="1.1" xmlns="http://www.w3.org/2000/svg"
                       xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <div className="title-area">
                  ...
                  <p>Successfully manage and track your players’ activity, analyse statistics for each game and
                    constantly keep your hand on your business’ pulse with our multifunctional backoffice.</p>
                  <div className="link-area mt-8"><a className="d-flex align-items-center" href="our-services-details">Learn
                    More<MdOutlineArrowForward/></a></div>
                </div>
              </div>
          ...
          <div className="row cus-mar ">
            <div className="col-sm-6 col-xl-4">
              <div
                ...
                <div className="counters d-flex align-items-center"><span className="display-one">500</span><span
                  className="display-one symbol">+</span></div>
                <p className="name-area fs-five position-absolute">Active Partners</p></div>
            </div>
            <div className="col-sm-6 col-xl-4">
              <div
                className="single-box py-6 box-style box-first d-center position-relative false">
                <div className="counters d-flex align-items-center"><span className="display-one">200</span><span
                  className="display-one">K+</span></div>
                <p className="name-area fs-five position-absolute">Active Players/Monthly</p></div>
            </div>
            <div className="col-sm-6 col-xl-4">
              <div
                className="single-box py-6 box-style box-first d-center position-relative false">
                <div className="counters d-flex align-items-center"><span className="display-one">30</span><span
                  className="display-one symbol">M+</span></div>
                <p className="name-area fs-five position-absolute">Transactions/Monthly</p></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <section className="our-games all-games overflow-hidden pt-120 pb-120"
        ...
        <div className="container singletab">
          <div className="row justify-content-center">
            <div className="col-lg-6">
              <div className="section-text text-center"><h4 className="sub-title">Crafting Unforgettable <span>Gaming Experiences</span>
              </h4><span
                className="fs-two heading mb-6">Our Games are <span>Vibrant</span> Worlds With<span>Charming</span> Characters</span>
                <p>Our projects feature unique mechanics, fine-tuned game play, and eye-catching visual style.Over 100
                  million people play our games every month</p></div>
            </div>
          </div>
          <div className="row justify-content-center">
            <div className="col-lg-6 text-center">
              <ul className="nav tablinks flex-wrap d-center mb-10 d-inline-flex gap-4 p-3 tab-area">
                <li className="nav-item">
                  <button className="nav-link d-center box-style btn-box p-0 false"><span
                    className="icon-area"><i className="ri-macbook-line fs-two"></i></span></button>
                </li>
                <li className="nav-item">
                  <button className="nav-link d-center box-style btn-box p-0 false"><span
                    className="icon-area"><i className="ri-apple-line fs-two"></i></span></button>
                </li>
                <li className="nav-item">
                  <button className="nav-link d-center box-style btn-box p-0 active"><span
                    className="icon-area"><i className="ri-google-play-line fs-two"></i></span></button>
                </li>
                <li className="nav-item">
                  <button className="nav-link d-center box-style btn-box p-0 false"><span
                    className="icon-area"><i className="ri-amazon-line fs-two"></i></span></button>
                </li>
                <li className="nav-item">
                  <button className="nav-link d-center box-style btn-box p-0 false"><span
                    className="icon-area"><i className="ri-windows-line fs-two"></i></span></button>
                </li>
                <li className="nav-item">
                  <button className="nav-link d-center box-style btn-box p-0 false"><span
                    className="icon-area"><i className="ri-steam-line fs-two"></i></span></button>
                </li>
                <li className="nav-item">
                  <button className="nav-link d-center box-style btn-box p-0 false"><span
                    className="icon-area"><i className="ri-app-store-line fs-two"></i></span></button>
                </li>
              </ul>
            </div>
          </div>
                    ...
                    <div className="col-xl-4 col-sm-6 col-8">
                      <div className="single-box">
                        ...
                        <div className="footer-area mb-7 text-center">
                          <div className="logo-area"><img alt="img" loading="lazy" width="80" height="80"
                                                          src={allGamesProfile1}/></div>
                          <h3 className="visible-slowly-bottom my-4">Crazy Wild</h3><p>Empire of the Stars</p>
                          <div className="btn-area alt-bg"><a className="box-style btn-box mt-7 d-center" href="game"
                          >Learn More</a></div>
                        </div>
                      </div>
                    </div>
        ...
        <div className="container pt-120 pb-120">
          <div className="row section-header justify-content-center">
            <div className="col-lg-6 text-center"><h4 className="sub-title">The
              Latest <span>Trends and Technologies</span></h4><span className="fs-two heading mb-6">Tips and Tricks from Our <span>Game Development Experts</span></span>
              <p>Behind the scenes, we share our game development process, research and development efforts, and
                reflections on our growth in the gaming industry</p></div>
          </div>
          <div className="row cus-mar">
                ...
                <div className="single-box">
                  <div className="position-relative d-grid align-items-center">
                    <div className="img-box">
                      <img alt="Image" loading="lazy" width="636" height="400" src={blogsImg1}/>
                    </div>
                    <div className="position-absolute cus-position bottom-0 start-0">
                      <div className="content-box p-3 p-sm-6">
                        <div className="top-bar d-flex align-items-center gap-3"><h5>News</h5>
                          <span>25 January,2023</span>
                        </div>
                        <a href="/blog-single"><h4 className="mt-3">Crafting Digital Worlds with Expertise</h4></a><a
                        className="end-area mt-8 d-center" href="/blog-single"><MdOutlineNorthEast/></a></div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="our-partners pt-120 pb-120">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-6">
              <div className="section-header text-center"><h4 className="sub-title"><span>Trusted</span> By</h4><span
                className="fs-two heading mb-6">We are happy to work with <span>global largest brands</span></span><p>We
                are proud to support industry leaders around the world.</p></div>
            </div>
          </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <div className="all-items mb-7 d-flex gap-3 justify-content-between flex-wrap">
                <div className="thumb"><img alt="Image" loading="lazy" width="207" height="46" src={brandLogo}/>
                </div>
                <div className="thumb"><img alt="Image" loading="lazy" width="207" height="46" src={brandLogo}/>
                </div>
                <div className="thumb"><img alt="Image" loading="lazy" width="207" height="46" src={brandLogo}/>
